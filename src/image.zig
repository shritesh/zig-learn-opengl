...
pub const Image = struct {
    ...
    pub fn load(filename: [:0]const u8, flags: struct { flip: bool = false }) !Image {
        ...
        const data = c.stbi_load(filename, &width, &height, &n_channels, 0) orelse return error.ImageLoadError;
